(function (win) {
	...
	function _getWrapperElement (id) {
				console.debug('marvinjslauncher :: _getWrapperElement (id)');
		var re = new RegExp(/^#.*/);
		if (typeof id !== "string") {
			return null;
		}
	...
	function _getPackage (wrapperElement) {
				console.debug('marvinjslauncher :: _getPackage (wrapperElement)');
	...
	function _createPackage(elementId, resolve, reject) {
				console.debug('marvinjslauncher :: _createPackage(elementId, resolve, reject)');
		if(elementId == null){
		...
		if (marvinPackage) {
			...
			wrapperElement.addEventListener("load", function handleSketchLoad (e) {
				console.debug('marvinjslauncher :: handleSketchLoad (e)');
	...
	function _createEditor(elementId, resolve, reject) {
				console.debug('marvinjslauncher :: _createEditor(elementId, resolve, reject)');
		if(elementId == null){
			reject("Element id can not be null.");
			return;
		}
	...
	win.MarvinJSUtil = {
		"getEditor": function getEditor (elementId) {
				console.debug('marvinjslauncher :: getEditor (elementId)');
			
	 		function createEditor (resolve, reject) {
				console.debug('marvinjslauncher :: createEditor (resolve, reject)');
		...
		,"getPackage": function getPackage (elementId) {
				console.debug('marvinjslauncher :: getPackage (elementId)');

			function createPackage (resolve, reject) {
				console.debug('marvinjslauncher :: createPackage (resolve, reject)');
